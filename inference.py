...
def inference(test_dir, model_filename, device, output_dir, use_logistic_mix,
              use_train_mode=False, teacher_force=False, teacher_length=-1,
              no_pedal=False, audio_hz=16000):
